/*
==============================================================================
== OntoRelCat : ontorelcat_api_ontorelquery_pri.sql
...
-- Création du schéma 'ontorelcat_api_ontorelquery' si celui-ci n'existe pas.
create schema if not exists ontorelcat_api_ontorelquery;
comment
on schema ontorelcat_api_ontorelquery is $$
...
begin
    atomic
select "ontorelcat_api_ontorelquery".get_table_id_class(class_iri_, ontorel_uuid_) as class_table_id,
...
p_inheritance_level >= 0 then
        return query
            with recursive class_hierarchy as (select oc.iri,
                                                      ontorelcat_api_ontorelquery.get_table_id_class(oc.iri, oc.ontorel_uuid) as table_id,
                                               ...
                                               union all
                                               select oc2.iri,
                                                      ontorelcat_api_ontorelquery.get_table_id_class(oc2.iri, oc2.ontorel_uuid) as table_id,
...
--           - 'Onto_class_axiom'
create
or replace function "ontorelcat_api_ontorelquery".get_entity_type(table_id_ varchar, ontorel_uuid_ varchar)
    returns table
            (
                table_id varchar,
                found_in varchar
...
--           - 'Onto_class_axiom'
create
or replace function "ontorelcat_api_ontorelquery".get_table_name_by_identifier(iri_ varchar, ontorel_uuid_ varchar)
    returns table
            (
                iri      varchar,
                found_in varchar
